...
export default function Education() {
  ...
  return (
    <section id="education" className="px-6 md:px-16 lg:px-32 py-24 bg-slate-100 dark:bg-slate-900/40">
      <motion.div
        ref={ref}
      ...
      >
        <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-slate-100">
          <span className="text-blue-600 dark:text-indigo-400 font-mono text-xl mr-3">05.</span>
          Education
        </h2>
