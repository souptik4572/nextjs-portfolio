  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-700/50 py-3"
          : "py-5"
      }`}
    >
          ...
          <ul className="hidden md:flex items-center gap-6">
            {portfolioData.layout.section_order.map((section, i) => (
              <li key={section}>
                <a
                  href={`#${section}`}
                  className="text-slate-600 dark:text-slate-400 hover:text-blue-600 dark:hover:text-indigo-400 transition-colors text-sm font-medium"
                >
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-0 bg-slate-900/80 dark:bg-slate-900/80 backdrop-blur-sm z-40 md:hidden"
            />
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-[75vw] max-w-sm bg-white dark:bg-slate-800 border-l border-slate-200 dark:border-slate-700 z-40 md:hidden"
            >
              <nav className="flex flex-col gap-2 p-8 pt-24">
                {portfolioData.layout.section_order.map((section, i) => (
                  <a
                    ...
                    className="text-slate-700 dark:text-slate-300 hover:text-blue-600 dark:hover:text-indigo-400 transition-colors py-3 px-4 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700/50 flex items-center gap-3"
                  >
