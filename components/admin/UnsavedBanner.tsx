    ...
    <AnimatePresence>
      {isDirty && (
        <motion.div
          ...
          className="fixed bottom-4 left-3 right-3 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 sm:w-max sm:max-w-[calc(100vw-2rem)] z-40 flex items-center gap-3 pl-4 pr-2 py-2 rounded-2xl border border-black/[0.10] dark:border-white/[0.10] bg-white/92 dark:bg-[#2c2c2e]/92 backdrop-blur-2xl shadow-xl shadow-black/12 dark:shadow-black/40"
        >
